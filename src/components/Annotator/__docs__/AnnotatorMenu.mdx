...
import * as Annotator from "./Annotator.stories.tsx";

<Meta of={Annotator} title="Annotator" />

# Annotator

Annotator component with different props.

#### Example

<Canvas of={Annotator.Primary} />

## Usage

```ts
import {Annotator} from "react-image-annotator";
