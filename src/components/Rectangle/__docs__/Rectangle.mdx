...
import * as Rectangle from "./Rectangle.stories.tsx";

<Meta of={Rectangle} title="Rectangle" />

# Rectangle

Rectangle component with different props.

#### Example

<Canvas of={Rectangle.Primary} />

## Usage

```ts
import {Rectangle} from "sld-ui";
