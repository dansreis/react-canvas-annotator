...
import * as AnnotatorMenu from "./AnnotatorMenu.stories.tsx";

<Meta of={AnnotatorMenu} title="AnnotatorMenu" />

# AnnotatorMenu

AnnotatorMenu component with different props.

#### Example

<Canvas of={AnnotatorMenu.Primary} />

## Usage

```ts
import {AnnotatorMenu} from "sld-ui";
