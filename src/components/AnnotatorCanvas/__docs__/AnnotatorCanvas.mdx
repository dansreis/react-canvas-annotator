...
import * as AnnotatorCanvas from "./AnnotatorCanvas.stories.tsx";

<Meta of={AnnotatorCanvas} title="AnnotatorCanvas" />
...
<Canvas of={AnnotatorCanvas.Primary} />

## Usage

```ts
import {AnnotatorCanvas} from "sld-ui";
