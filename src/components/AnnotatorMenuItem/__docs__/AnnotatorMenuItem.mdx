...
import * as AnnotatorMenuItem from "./AnnotatorMenuItem.stories.tsx";

<Meta of={AnnotatorMenuItem} title="AnnotatorMenuItem" />

# AnnotatorMenuItem

AnnotatorMenuItem component with different props.

#### Example

<Canvas of={AnnotatorMenuItem.Primary} />

## Usage

```ts
import {AnnotatorMenuItem} from "sld-ui";
